Esté CRM esta hecho para ingresar clientes a nuestra base de datos, que para esté proyecto utilizamos IndexedDB para guardar los clientes en caso de que la página se recargue.
